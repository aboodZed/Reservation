                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="defult_reservation_hours" type="number" value="12"
                                        class="form-control @error('defult_reservation_hours') is-invalid @enderror"
                                        name="defult_reservation_hours" required autocomplete="defult_reservation_hours">

                                    @error('defult_reservation_hours')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
